...
public class RtpManager {
	 ...
	 */
	public com.nist.jrtp.RtpSession createRtpSession(int myRtpRecvPort,
													 String remoteIpAddress, int remoteRtpRecvPort)
			throws SocketException, IOException {

		return new com.nist.jrtp.RtpSession(this.myIpAddress, myRtpRecvPort, remoteIpAddress,
				remoteRtpRecvPort);
	...
	public com.nist.jrtp.RtpSession createRtpSession(int myRtpRecvPort)
		...
		return new com.nist.jrtp.RtpSession(this.myIpAddress, myRtpRecvPort);
